			...
			<table class="auto-style1" style="width: 100%">
				...
				<tr>
					...
					<td><springForm:input id="empId" path="empId"
						...
						class="auto-style5">*</span> <springForm:errors path="empId"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td class="auto-style2" style="width: 485px"><span
					...
					<td><springForm:input id="firstName" path="firstName"
						...
						class="auto-style5">*</span> <springForm:errors path="firstName"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td class="auto-style2" style="width: 485px"><span
					...
					<td style="height: 23px"><springForm:input id="lastName"
							path="lastName" value="${employee.lastName}" tabindex="2" /><span
				...
				<tr>
					...
					<td><springForm:input id="ssn" path="ssn"
							value="${employee.ssn}" tabindex="5" maxlength="20" /><span
						class="auto-style5">*</span> <springForm:errors path="ssn"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td class="auto-style2" style="width: 485px"><span
					...
					<td><springForm:input id="city" path="city"
							value="${employee.city}" tabindex="5" maxlength="20" /><span
						class="auto-style5">*</span> <springForm:errors path="city"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td class="auto-style2" style="width: 485px"><span
					...
					<td><springForm:input id="state" path="state"
							value="${employee.state}" tabindex="6" /> <span
						class="auto-style5">*</span> <springForm:errors path="state"
							cssClass="error" /></td>
				</tr>
				<tr>
					<td class="auto-style2" style="width: 485px"><span
				...
				<tr>
					...
					<td><springForm:input id="phone" path="phone"
							value="${employee.phone}" tabindex="7" maxlength="12" /><span
						class="auto-style5">*</span> <springForm:errors path="phone"
							cssClass="error" /></td>
				</tr>
				...
				<tr>
					...
					<td><fmt:formatDate value="${employee.dateOfBirth}"
							var="dateString" pattern="MM/dd/yyyy" /> <springForm:input
							path="dateOfBirth" value="${dateString}" /></td>
				...
				<springForm:hidden path="Id" value="${Id}" />
